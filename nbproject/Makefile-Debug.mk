...
${OBJECTDIR}/readerswriters.o: nbproject/Makefile-${CND_CONF}.mk readerswriters.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/readerswriters.o readerswriters.c

${OBJECTDIR}/messagequeues.o: nbproject/Makefile-${CND_CONF}.mk messagequeues.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/messagequeues.o messagequeues.c
...
${OBJECTDIR}/ipt.o: nbproject/Makefile-${CND_CONF}.mk ipt.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/ipt.o ipt.c
...
${OBJECTDIR}/aging.o: nbproject/Makefile-${CND_CONF}.mk aging.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/aging.o aging.c
...
${OBJECTDIR}/process.o: nbproject/Makefile-${CND_CONF}.mk process.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/process.o process.c
